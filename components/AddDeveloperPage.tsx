          ...
          <>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="bg-[#0A2B4C] px-6 py-4 border-b border-[#08223c]">
                    <h2 className="text-white font-semibold text-lg">Company Details</h2>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-gray-700 mb-2">Headquarters Location <span className="text-red-500">*</span></label>
                    ...
                    <div>
                         <h3 className="text-lg font-bold text-[#0A2B4C] mb-4">Company Profile</h3>
                         <div className="space-y-6">
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-2">About Company <span className="text-red-500">*</span></label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" min="1900" placeholder="e.g. 2010" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#F9A826] focus:ring-1 focus:ring-[#F9A826]" />
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 mb-2">Projects Completed</label>
                                    <input type="number" min="0" placeholder="e.g. 15" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-[#F9A826] focus:ring-1 focus:ring-[#F9A826]" />
                                </div>
                            </div>
                         </div>
                    </div>
